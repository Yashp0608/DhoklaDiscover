...
DEEPSEEK_API_TOKEN="sk-9959dc40d8cc4ad996a10cad47af7644"
...
def get_recommendations():
    ...
    co = cohere.Client(api_key="mFXw8tHIk4Tgl87ZGl0zvfM6Wn62KL4bqGKZZlFx")
 
    prompt = "You are a itinerary generator. Generate a detailed trip itinerary based on the parsed data, covering the destination in the provided number of days. Ensure that the itinerary includes changing the accommodation for every day and does not exceed the specified number of days, shorten the hotel details. Please provide the number of days for the trip explicitly:" + iter_data
