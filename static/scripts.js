...
function printRecommendations() {
  ...
  var printableHTML = `
    ...
    <head>
      ...
      <title style='font-weight:bold'>Dhokla Discover</title>
      <style>
        @page {
          @top-left {
        ...
        .header_print pre:first-of-type {
          margin-left: 10px; /* Adds some space between logo and text */
          text-align: left;
        }
        .header_print pre:last-of-type {
          position: absolute;
      ...
      <body>
      <header class="header_print">
        <pre>             +91 9428353338
        yashptl682003@gmail.com</pre>
      </header>
        <div id="recommendation-results">
          ${recommendationContent}
        </div>
        <footer class="footer_print">
          <pre>&copy; ${new Date().getFullYear()} Dhokla Discover - 2024. All rights reserved.</pre>
        </footer>
        </body>
      </html>
      `;
